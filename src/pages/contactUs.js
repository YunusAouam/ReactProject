...
export default function ContactUs() {
  ...
  return (
    <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form action="#" method="POST" className="mx-auto lg:mt-4 max-w-xl sm:mt-20">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-transparent"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
